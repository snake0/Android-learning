...
public class ContextCompat {
    ...
    public static File[] getExternalFilesDirs(Context context, String str) {
        ...
        if (i >= 8) {
            ...
            externalFilesDir = buildPath(Environment.getExternalStorageDirectory(), DIR_ANDROID, "data", context.getPackageName(), "files", str);
        }
    ...
    public static File[] getExternalCacheDirs(Context context) {
        ...
        if (i >= 8) {
            ...
            externalCacheDir = buildPath(Environment.getExternalStorageDirectory(), DIR_ANDROID, "data", context.getPackageName(), DIR_CACHE);
        }

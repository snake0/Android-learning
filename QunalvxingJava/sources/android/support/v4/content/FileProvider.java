    ...
    class SimplePathStrategy implements PathStrategy {
        ...
        public Uri getUriForFile(File file) {
            try {
                ...
                return new Builder().scheme(AIUIConstant.KEY_CONTENT).authority(this.mAuthority).encodedPath(Uri.encode((String) entry.getKey()) + IOUtils.DIR_SEPARATOR_UNIX + Uri.encode(path, "/")).build();
            } catch (IOException e) {

    ...
    public void onMeasure(int i, int i2) {
        ...
        while (i7 < childCount) {
            ...
            if (childAt.getVisibility() == 8) {
                ...
                if (i3 == Integer.MIN_VALUE && i5 > i9) {
                    i9 = Math.min(i5, mode2);
                }
                i5 = i8 - mode;
                boolean z = i5 < 0;
            ...
            for (i3 = 0; i3 < childCount; i3++) {
                ...
                if (childAt2.getVisibility() != 8) {
                    ...
                    if (childAt2.getVisibility() != 8) {
                        ...
                        if (i6 == 0 || childAt2 == this.mSlideableView) {
                            if (layoutParams.weight > 0.0f) {
                                if (layoutParams.width != 0) {
                                ...
                                if (i6 != 0) {
                                    ...
                                    childAt2.measure(MeasureSpec.makeMeasureSpec(((int) ((layoutParams.weight * ((float) Math.max(0, i8))) / f)) + i5, 1073741824), mode);
                                }
                            }
                        } else if (layoutParams.width < 0 && (i5 > i10 || layoutParams.weight > 0.0f)) {
                            if (obj == null) {
                            ...
                            childAt2.measure(MeasureSpec.makeMeasureSpec(i10, 1073741824), size2);
                        }
                    }
                }
            }
        }
        setMeasuredDimension(i4, (getPaddingTop() + i9) + getPaddingBottom());
        this.mCanSlide = i6;
        if (this.mDragHelper.getViewDragState() != 0 && i6 == 0) {

...
public final class LocationClientOption {
    ...
    public int wifiCacheTimeOut = ProgressType.PRO_END;
    ...
    public void setCoorType(String str) {
        ...
        if (toLowerCase.equals(CoordinateType.GCJ02) || toLowerCase.equals(BDLocation.BDLOCATION_GCJ02_TO_BD09) || toLowerCase.equals("bd09ll")) {
    ...
    public void setIsNeedAddress(boolean z) {
        if (z) {
            this.addrType = SpeechConstant.PLUS_LOCAL_ALL;
        } else {

...
public class b {
    ...
    public static LatLng a(float f, float f2, String str) {
        ...
        return !bundle.isEmpty() ? new LatLng(bundle.getDouble(MapViewConstants.ATTR_Y), bundle.getDouble(MapViewConstants.ATTR_X)) : null;
    }
    ...
    public static LatLng a(GeoPoint geoPoint) {
        ...
        if (aVar2.a > 2.0037508342E7d) {
            aVar2.a = (aVar2.a - 2.0037508342E7d) - 2.1525280870093866E-7d;
        } else if (aVar2.a < -2.0037508342E7d) {
            aVar2.a = 2.0037508342E7d - (-2.0037508342E7d - aVar2.a);
        }
        aVar2.b = aVar.b;
    ...
    public static Point b(LatLng latLng) {
        ...
        point.setmPtx((int) bundle.getDouble(MapViewConstants.ATTR_X));
        point.setmPty((int) bundle.getDouble(MapViewConstants.ATTR_Y));
        return point;
    }
        ...
        if (arrayList2.size() > 0) {
            ...
            while (true) {
                ...
                if (SDKInitializer.getCoordType() == CoordType.GCJ02) {
                    arrayList.add(CoordTrans.baiduToGcj(a(new GeoPoint((double) (point.y / 100), (double) (point.x / 100)))));
                } else {
    ...
    public static List<List<LatLng>> d(String str) {
        ...
        while (it.hasNext()) {
            ...
            while (it2.hasNext()) {
                ...
                if (SDKInitializer.getCoordType() == CoordType.GCJ02) {
                    arrayList3.add(CoordTrans.baiduToGcj(a(new GeoPoint((double) (point.y / 100), (double) (point.x / 100)))));
                } else {

...
final class PreHoneycombCompat {
    ...
    static Property<View, Float> X = new FloatProperty<View>(MapViewConstants.ATTR_X) {
        public void setValue(View view, float f) {
    ...
    static Property<View, Float> Y = new FloatProperty<View>(MapViewConstants.ATTR_Y) {
        public void setValue(View view, float f) {

...
import com.iflytek.cloud.thirdparty.be.a;
...
public class bd extends be {
    ...
    public void a(SpeechError speechError) {
        ...
        this.i.a("rec_ustop", this.d ? BuildConfig.VERSION_NAME : "0", false);
        this.e.a("sessinfo", this.i.a());
        cc.a("SessionEndBegin", null);
        if (this.u) {
            this.e.a("user abort");
        } else if (speechError != null) {
            this.e.a(UIData.ERROR + speechError.getErrorCode());
        } else {
            this.e.a(UIData.SUCCESS);
        }
    ...
    /* Access modifiers changed, original: protected */
    public void a(StringBuffer stringBuffer, byte[] bArr, boolean z, boolean z2) {
    ...
    public void b(Message message) {
        ...
        byte[] bArr = (byte[]) hashMap.get(SpeechEvent.KEY_EVENT_RECORD_DATA);
        String str = (String) hashMap.get("ssub");
        StringBuffer stringBuffer = (StringBuffer) this.o.get(str);
        String e = ((ce) this.n.get(str)).e(SpeechConstant.MFV_DATA_PATH);
    ...
    public void i() {
        if (v()) {
            ...
            if (this.a != null) {
                this.a.onEvent(SpeechEvent.EVENT_NETPREF, c, 0, null);
            }
    ...
    /* Access modifiers changed, original: 0000 */
    public void stusCb(char[] cArr, int i, int i2, byte[] bArr, int i3) {

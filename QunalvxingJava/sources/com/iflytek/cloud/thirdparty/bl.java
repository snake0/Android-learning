...
public class bl extends be {
    ...
    public void a(SpeechError speechError) {
        ...
        if (this.e == null) {
            ...
            this.d.a(UIData.ERROR + speechError.getErrorCode());
            cb.a("QTts Error Code = " + speechError.getErrorCode());
        } else {
            this.d.a(UIData.SUCCESS);
        }
    ...
    public String r() {
        return VERSION.SDK_INT > 26 ? x().b(SpeechConstant.TEXT_ENCODING, "gb2312") : x().b(SpeechConstant.TEXT_ENCODING, "unicode");
    }
}

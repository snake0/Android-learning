...
public class cg {
    ...
    public static int a(be beVar) {
        return (beVar == null || !beVar.m()) ? m_AppUI.MSG_APP_SAVESCREEN : 5000;
    }
    ...
    public static String a(Context context) {
        ...
        ce a = bp.a(context);
        CharSequence charSequence = a.e("os.imsi") + "|" + a.e("os.imei");
        if (charSequence.length() < 10) {
            charSequence = a.e("net.mac");
        }
        return (TextUtils.isEmpty(charSequence) || charSequence.length() <= 0) ? null : charSequence;
    }
    ...
    public static String a(Context context, be beVar) {
        ...
        a(context, b);
        b.a(SpeechConstant.NET_TIMEOUT, "20000", false);
        b.a("auth", BuildConfig.VERSION_NAME, false);
    ...
    public static String a(Context context, String str, be beVar) {
        ...
        b.a("ssm", BuildConfig.VERSION_NAME, false);
    ...
    private static void a(ce ceVar) {
        if (ceVar != null && Setting.getLogLevel() != LOG_LEVEL.none) {
            ...
            ceVar.a("log", logPath);
            ceVar.a("lvl", "" + i);
            ceVar.a("output", BuildConfig.VERSION_NAME, false);
        }
    }
    ...
    public static int b(be beVar) {
        return (beVar == null || !beVar.m()) ? AudioDetector.DEF_EOS : 1800;
    }
    ...
    public static String b(Context context, String str, be beVar) {
        ...
        b.a("mver", "2.0", false);
        b.a(AIUIConstant.KEY_SERVER_URL, "http://imfv.openspeech.cn/msp.do", false);
    ...
    private static void b(ce ceVar) {
        ...
        if (utility != null) {
            ...
            if (!ceVar.g("speed_increase")) {
                int a = ceVar.a(SpeechConstant.SPEED, 50);
                if (a <= 100) {
                    ceVar.a(SpeechConstant.SPEED, "" + a);
                    ceVar.a("speed_increase", BuildConfig.VERSION_NAME);
                } else if (100 < a && a <= 150 && (TextUtils.isEmpty(parameter) || parameter.contains("5.5."))) {
                    ceVar.a(SpeechConstant.SPEED, "" + (a - 50));
                    ceVar.a("speed_increase", "2");
                } else if (100 < a && a <= 200) {
                    ceVar.a(SpeechConstant.SPEED, "" + (a - 100));
    ...
    public static String e(Context context, be beVar) {
        ...
        b.a(SpeechConstant.TEXT_ENCODING, beVar.r(), false);
        b.a("plev", BuildConfig.VERSION_NAME, false);
        b.a("accent", "mandarin", false);
        b.a("domain", "ise", false);

...
public interface TaskCallback<T extends AbsConductor> {
    ...
    public class AsHandler<T extends AbsConductor> implements TaskCallback<T> {
        ...
        public void onMsgRequest(T t, boolean z) {
            this.a.obtainMessage(TaskCode.TASK_REQUEST.getCode(), t).sendToTarget();
        }

        public void onMsgResult(T t, boolean z) {
            this.a.obtainMessage(TaskCode.TASK_RESULT.getCode(), t).sendToTarget();
        }

        public void onMsgError(T t, boolean z) {
            this.a.obtainMessage(TaskCode.TASK_ERROR.getCode(), t).sendToTarget();
        }

        public void onMsgProgress(T t, boolean z) {
            this.a.obtainMessage(TaskCode.TASK_PENDING.getCode(), t).sendToTarget();
        }
        ...
        public void onMsgCancel(T t, boolean z) {
            this.a.obtainMessage(TaskCode.TASK_CANCEL.getCode(), t).sendToTarget();
        }

        public void onMsgCacheHit(T t, boolean z) {
            this.a.obtainMessage(TaskCode.TASK_CACHE_HIT.getCode(), t).sendToTarget();
        }
    }

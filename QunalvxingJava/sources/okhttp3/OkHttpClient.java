...
public class OkHttpClient implements Cloneable, Factory, WebSocket.Factory {
    ...
    public final class Builder {
        ...
        public Builder connectTimeout(long j, TimeUnit timeUnit) {
            this.connectTimeout = checkDuration(SpeechConstant.NET_TIMEOUT, j, timeUnit);
            return this;
        }

        public Builder readTimeout(long j, TimeUnit timeUnit) {
            this.readTimeout = checkDuration(SpeechConstant.NET_TIMEOUT, j, timeUnit);
            return this;
        }

        public Builder writeTimeout(long j, TimeUnit timeUnit) {
            this.writeTimeout = checkDuration(SpeechConstant.NET_TIMEOUT, j, timeUnit);
            return this;
        }

...
public final class HttpUrl {
    ...
    public final class Builder {
        ...
        private void resolvePath(String str, int i, int i2) {
            if (i != i2) {
                ...
                if (charAt == IOUtils.DIR_SEPARATOR_UNIX || charAt == IOUtils.DIR_SEPARATOR_WINDOWS) {
                    this.encodedPathSegments.clear();
                    this.encodedPathSegments.add("");
                    i++;
                } else {
        ...
        private static int schemeDelimiterOffset(String str, int i, int i2) {
            ...
            while (i3 < i2) {
                ...
                if ((charAt2 >= 'a' && charAt2 <= 'z') || ((charAt2 >= 'A' && charAt2 <= 'Z') || ((charAt2 >= '0' && charAt2 <= '9') || charAt2 == '+' || charAt2 == '-' || charAt2 == FilenameUtils.EXTENSION_SEPARATOR))) {
                    i3++;
                } else if (charAt2 == ':') {
                    return i3;
                } else {
     ...
     */
                ...
                if (i3 + 2 > i2 || !str.regionMatches(i3, "::", 0, 2)) {
                    if (i6 != 0) {
                        if (str.regionMatches(i3, ":", 0, 1)) {
                            ...
                            if (!decodeIpv4Suffix(str, i4, i2, bArr, i6 - 2)) {
                                return null;
                            }
                            i6 += 2;
                        }
        ...
        private static boolean decodeIpv4Suffix(String str, int i, int i2, byte[] bArr, int i3) {
            ...
            while (i4 < i2) {
                ...
                if (i5 != i3) {
                    if (str.charAt(i4) != FilenameUtils.EXTENSION_SEPARATOR) {
                        return false;
                    }
                    i4++;
                }
    ...
    public List<String> encodedPathSegments() {
        ...
        while (indexOf < delimiterOffset) {
            int i = indexOf + 1;
            indexOf = Util.delimiterOffset(this.url, i, delimiterOffset, (char) IOUtils.DIR_SEPARATOR_UNIX);
    ...
    static String canonicalize(String str, int i, int i2, String str2, boolean z, boolean z2, boolean z3, boolean z4) {
        ...
        while (i3 < i2) {
            int codePointAt = str.codePointAt(i3);
            if (codePointAt < 32 || codePointAt == TransportMediator.KEYCODE_MEDIA_PAUSE || ((codePointAt >= 128 && z4) || str2.indexOf(codePointAt) != -1 || ((codePointAt == 37 && (!z || (z2 && !percentEncoded(str, i3, i2)))) || (codePointAt == 43 && z3)))) {
                Buffer buffer = new Buffer();
                buffer.writeUtf8(str, i, i3);
    ...
    static void canonicalize(Buffer buffer, String str, int i, int i2, String str2, boolean z, boolean z2, boolean z3, boolean z4) {
        ...
        while (i < i2) {
            ...
            if (!(z && (codePointAt == 9 || codePointAt == 10 || codePointAt == 12 || codePointAt == 13))) {
                ...
                } else if (codePointAt < 32 || codePointAt == TransportMediator.KEYCODE_MEDIA_PAUSE || ((codePointAt >= 128 && z4) || str2.indexOf(codePointAt) != -1 || (codePointAt == 37 && (!z || (z2 && !percentEncoded(str, i, i2)))))) {
                    if (buffer2 == null) {
                        buffer2 = new Buffer();
                    }

...
final class DistinguishedNameParser {
    ...
    private String nextAT() {
        ...
        if (this.end - this.beg > 4 && this.chars[this.beg + 3] == FilenameUtils.EXTENSION_SEPARATOR && ((this.chars[this.beg] == 'O' || this.chars[this.beg] == 'o') && ((this.chars[this.beg + 1] == 'I' || this.chars[this.beg + 1] == 'i') && (this.chars[this.beg + 2] == 'D' || this.chars[this.beg + 2] == 'd')))) {
            this.beg += 4;
        }
    ...
    private char getUTF8() {
        ...
        for (i = 0; i < i2; i++) {
            this.pos++;
            if (this.pos == this.length || this.chars[this.pos] != IOUtils.DIR_SEPARATOR_WINDOWS) {
                return '?';
            }
            this.pos++;

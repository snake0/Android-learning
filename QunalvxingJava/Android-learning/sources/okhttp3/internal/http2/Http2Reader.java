...
final class Http2Reader implements Closeable {
    ...
    final class ContinuationSource implements Source {
        ...
        private void readContinuationHeader() {
            ...
            this.streamId = this.source.readInt() & ProgressType.PRO_END;
            if (readByte != (byte) 9) {
    ...
    public boolean nextFrame(boolean z, Handler handler) {
        try {
            ...
            if (!z || readByte == (byte) 4) {
                ...
                int readInt = this.source.readInt() & ProgressType.PRO_END;
                if (logger.isLoggable(Level.FINE)) {
    ...
    private void readData(Handler handler, int i, byte b, int i2) {
        ...
        handler.data(z, i2, this.source, lengthWithoutPadding(i, b, s2));
    ...
    private void readPriority(Handler handler, int i) {
        ...
        handler.priority(i, readInt & ProgressType.PRO_END, (this.source.readByte() & 255) + 1, (Integer.MIN_VALUE & readInt) != 0);
    }
    ...
    private void readPushPromise(Handler handler, int i, byte b, int i2) {
        ...
        handler.pushPromise(i2, this.source.readInt() & ProgressType.PRO_END, readHeaderBlock(lengthWithoutPadding(i - 4, b, s), s, b, i2));
    }

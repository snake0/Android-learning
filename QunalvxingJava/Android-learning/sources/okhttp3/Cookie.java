...
public final class Cookie {
    ...
    private static boolean domainMatch(HttpUrl httpUrl, String str) {
        ...
        if (host.endsWith(str) && host.charAt((host.length() - str.length()) - 1) == FilenameUtils.EXTENSION_SEPARATOR && !Util.verifyAsIpAddress(host)) {
            return true;
        }
        return false;
    }
    ...
    private static boolean pathMatch(HttpUrl httpUrl, String str) {
        ...
        if (encodedPath.startsWith(str) && (str.endsWith("/") || encodedPath.charAt(str.length()) == IOUtils.DIR_SEPARATOR_UNIX)) {
            return true;
        }
        return false;
    }
    ...
    static Cookie parse(long j, HttpUrl httpUrl, String str) {
        ...
        while (delimiterOffset < length) {
            long j5;
            delimiterOffset3 = Util.delimiterOffset(str, delimiterOffset, length, ';');
        ...
        if (str3 == null || !str3.startsWith("/")) {
            ...
            delimiterOffset3 = str3.lastIndexOf(47);
            substring = delimiterOffset3 != 0 ? str3.substring(0, delimiterOffset3) : "/";
        } else {
            substring = str3;
        }
    ...
    private static int dateCharacterOffset(String str, int i, int i2, boolean z) {
        for (int i3 = i; i3 < i2; i3++) {
            ...
            Object obj2 = ((charAt >= ' ' || charAt == 9) && charAt < 127 && ((charAt < '0' || charAt > '9') && ((charAt < 'a' || charAt > 'z') && ((charAt < 'A' || charAt > 'Z') && charAt != ':')))) ? null : 1;
            if (z) {
                obj = null;
            } else {
                obj = 1;

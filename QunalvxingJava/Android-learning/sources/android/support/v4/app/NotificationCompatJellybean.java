...
class NotificationCompatJellybean {
    ...
    public static android.support.v4.app.NotificationCompatBase.Action getAction(android.app.Notification r8, int r9, android.support.v4.app.NotificationCompatBase.Action.Factory r10, android.support.v4.app.RemoteInputCompatBase.RemoteInput.Factory r11) {
        ...
        r7 = sActionsLock;
        monitor-enter(r7);
        r0 = getActionObjectsLocked(r8);	 Catch:{ IllegalAccessException -> 0x003d }
        r1 = r0[r9];	 Catch:{ IllegalAccessException -> 0x003d }
        r0 = getExtras(r8);	 Catch:{ IllegalAccessException -> 0x003d }
        if (r0 == 0) goto L_0x004e;
    L_0x0010:
        r2 = "android.support.actionExtras";
        r0 = r0.getSparseParcelableArray(r2);	 Catch:{ IllegalAccessException -> 0x003d }
        if (r0 == 0) goto L_0x004e;
    L_0x0018:
        r0 = r0.get(r9);	 Catch:{ IllegalAccessException -> 0x003d }
        r0 = (android.os.Bundle) r0;	 Catch:{ IllegalAccessException -> 0x003d }
        r5 = r0;
    L_0x001f:
        r0 = sActionIconField;	 Catch:{ IllegalAccessException -> 0x003d }
        r2 = r0.getInt(r1);	 Catch:{ IllegalAccessException -> 0x003d }
        r0 = sActionTitleField;	 Catch:{ IllegalAccessException -> 0x003d }
        r3 = r0.get(r1);	 Catch:{ IllegalAccessException -> 0x003d }
        r3 = (java.lang.CharSequence) r3;	 Catch:{ IllegalAccessException -> 0x003d }
        r0 = sActionIntentField;	 Catch:{ IllegalAccessException -> 0x003d }
        r4 = r0.get(r1);	 Catch:{ IllegalAccessException -> 0x003d }
        r4 = (android.app.PendingIntent) r4;	 Catch:{ IllegalAccessException -> 0x003d }
        r0 = r10;
        r1 = r11;
        r0 = readAction(r0, r1, r2, r3, r4, r5);	 Catch:{ IllegalAccessException -> 0x003d }
        monitor-exit(r7);	 Catch:{ all -> 0x004b }
    L_0x003c:
        return r0;
    L_0x003d:
        r0 = move-exception;
        r1 = "NotificationCompat";
        r2 = "Unable to access notification actions";

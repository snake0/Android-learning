...
class MediaRouterJellybean {
    ...
    class CallbackProxy<T extends Callback> extends android.media.MediaRouter.Callback {
    ...
    class VolumeCallbackProxy<T extends VolumeCallback> extends android.media.MediaRouter.VolumeCallback {
        protected final T mCallback;

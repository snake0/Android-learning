    ...
    private void setupAnimators() {
        ...
        AnonymousClass1 anonymousClass1 = new Animation() {
            public void applyTransformation(float f, Transformation transformation) {
                ...
                float access$100 = MaterialProgressDrawable.this.getMinProgressArc(ring);
                ...
                if (f > 0.5f) {
                    ring.setEndTrim(((MaterialProgressDrawable.MAX_PROGRESS_ARC - access$100) * MaterialProgressDrawable.MATERIAL_INTERPOLATOR.getInterpolation((f - 0.5f) / 0.5f)) + startingEndTrim);
                }

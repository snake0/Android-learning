...
public class a {
    ...
    private static void c(Context context, int i) {
        ...
        stringBuilder.append("&target=").append(BuildConfig.VERSION_NAME);
        stringBuilder.append("&src=").append("sdk_[" + g + "]");
        Intent intent = new Intent("android.intent.action.VIEW", Uri.parse(stringBuilder.toString()));
        intent.setFlags(268435456);
        context.startActivity(intent);
    ...
    private static boolean h() {
        try {
            ...
            if (a != null) {
                ...
                Bundle bundle2 = new Bundle();
                if (p != null) {
                    bundle2.putString(AIUIConstant.KEY_UID, p);
                } else {
                    bundle2.putString(AIUIConstant.KEY_UID, "");
                }
                bundle.putBundle("base_params", bundle2);
                bundle2 = new Bundle();
                bundle2.putString("launch_from", "sdk_[" + g + "]");
            ...
            if (a != null) {
                ...
                while (i2 < j.size()) {
                    if (((DispathcPoiData) j.get(i2)).name == null || ((DispathcPoiData) j.get(i2)).name.equals("")) {
                        ...
                        try {
                            jSONObject.put(AIUIConstant.KEY_NAME, ((DispathcPoiData) j.get(i2)).name);
                            ...
                            jSONObject.put(AIUIConstant.KEY_UID, ((DispathcPoiData) j.get(i2)).uid);
                            i = i3 + 1;
                            try {
                ...
                bundle2.putString(SpeechEvent.KEY_EVENT_RECORD_DATA, jSONArray.toString());

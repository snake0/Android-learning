...
public final class MapStatus implements Parcelable {
    ...
    static MapStatus a(ab abVar) {
        ...
        float f = (float) abVar.b;
        double d = abVar.e;
        double d2 = abVar.d;
        LatLng mc2ll = CoordUtil.mc2ll(new GeoPoint(d, d2));
        float f2 = (float) abVar.c;
        float f3 = abVar.a;
        Point point = new Point(abVar.f, abVar.g);
        LatLng mc2ll2 = CoordUtil.mc2ll(new GeoPoint((double) abVar.k.e.y, (double) abVar.k.e.x));
        LatLng mc2ll3 = CoordUtil.mc2ll(new GeoPoint((double) abVar.k.f.y, (double) abVar.k.f.x));
        LatLng mc2ll4 = CoordUtil.mc2ll(new GeoPoint((double) abVar.k.h.y, (double) abVar.k.h.x));
        LatLng mc2ll5 = CoordUtil.mc2ll(new GeoPoint((double) abVar.k.g.y, (double) abVar.k.g.x));

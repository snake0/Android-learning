...
public final class Base64 {
    ...
    public static String encode(byte[] bArr, String str) {
        ...
        for (int i3 = 0; i3 < length2; i3 += 3) {
            i = i2 + 1;
            bArr2[i2] = a[(bArr[i3] & 255) >> 2];
            i2 = i + 1;
            bArr2[i] = a[((bArr[i3] & 3) << 4) | ((bArr[i3 + 1] & 255) >> 4)];
            int i4 = i2 + 1;
            bArr2[i2] = a[((bArr[i3 + 1] & 15) << 2) | ((bArr[i3 + 2] & 255) >> 6)];
            i = i4 + 1;
            bArr2[i4] = a[bArr[i3 + 2] & 63];
        ...
        switch (bArr.length % 3) {
            ...
            case 2:
                ...
                i = i2 + 1;
                bArr2[i2] = a[(bArr[length2 + 1] & 15) << 2];
                length = i + 1;
                bArr2[i] = (byte) 61;
                break;
            default:

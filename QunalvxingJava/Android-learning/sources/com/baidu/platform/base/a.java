...
public abstract class a {
    ...
    private int c(String str) {
        ...
        try {
            JSONObject jSONObject = new JSONObject(str);
            return jSONObject.has("status") ? jSONObject.getInt("status") : jSONObject.has("status_sp") ? jSONObject.getInt("status_sp") : jSONObject.has(SpeechUtility.TAG_RESOURCE_RESULT) ? jSONObject.optJSONObject(SpeechUtility.TAG_RESOURCE_RESULT).optInt(UIData.ERROR) : 10204;
        } catch (JSONException e) {

...
public class dj {
    ...
    private static void c(Context context) {
        ...
        try {
            queryIntentServices = context.getPackageManager().queryIntentServices(new Intent("com.iflytek.common.ACTION_LAUNCH"), 224);
        } catch (Exception e) {
            dr.b("LaunchImpl", "", e);
        ...
        for (ResolveInfo a : queryIntentServices) {
            a(context, a);
        }
    }

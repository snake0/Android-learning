...
public class bj {
    ...
    public synchronized byte[] a(Context context, be beVar) {
    ...
    public synchronized byte[] a(Context context, be beVar, String str) {
        byte[] bytes;
        synchronized (a) {
            String c = cg.c(context, beVar);
    ...
    public synchronized byte[] a(Context context, String str, byte[] bArr, be beVar) {
        byte[] QMSPUploadData;
        synchronized (a) {
            String c = cg.c(context, beVar);

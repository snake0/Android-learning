...
public class ax extends be implements PcmRecordListener {
    ...
    private void a(boolean z, byte[] bArr) {
        ...
        if (bArr != null && bArr.length > 0) {
            ...
            String e = x().e(SpeechConstant.LOCAL_GRAMMAR);
        ...
        if (this.a != null && v()) {
            ...
            if (z && x().a("request_audio_url", false)) {
                bundle = new Bundle();
                bundle.putString(SpeechEvent.KEY_EVENT_AUDIO_URL, this.h.d());
    ...
    public void a(SpeechError speechError) {
        ...
        this.o.a("rec_ustop", this.e ? BuildConfig.VERSION_NAME : "0", false);
        this.h.a("sessinfo", this.o.a());
        cc.a("SessionEndBegin", null);
        if (this.u) {
            this.h.a("user abort");
        } else if (speechError != null) {
            this.h.a(UIData.ERROR + speechError.getErrorCode());
        } else {
            this.h.a(UIData.SUCCESS);
        }
    ...
    public void onRecordBuffer(byte[] bArr, int i, int i2) {
        if (bArr != null && i2 > 0 && bArr.length >= i2 && i2 > 0 && v()) {
            ...
            if (this.p <= 0) {
                ...
                bArr2 = new byte[(i2 - this.p)];
                System.arraycopy(bArr, this.p + i, bArr2, 0, i2 - this.p);
                d(obtainMessage(2, bArr2));
                this.p = 0;
            }
        }
    ...
    public void rsltCb(char[] cArr, byte[] bArr, int i, int i2) {
        ...
        if (hasMessages(4)) {
            a(obtainMessage, be.a.normal, false, 0);
        } else {
            a(obtainMessage, be.a.max, false, 0);
        }
    }

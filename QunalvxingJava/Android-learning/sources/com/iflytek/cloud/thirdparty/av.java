...
public class av extends be implements PcmRecordListener {
    ...
    public void b() {
        ...
        byte[] a = l.booleanValue() ? BuildConfig.VERSION_NAME.equals(x().e(SpeechConstant.TEXT_BOM)) ? bt.a(this.i) : this.i : BuildConfig.VERSION_NAME.equals(x().e(SpeechConstant.TEXT_BOM)) ? bt.a(this.j) : this.j.getBytes("gb2312");
        au auVar = this.e;
    ...
    public void c() {
        ...
        if ("utf-8".equals(x().e(SpeechConstant.TEXT_ENCODING)) && Locale.CHINA.toString().equalsIgnoreCase(x().e("language"))) {
            x().a(SpeechConstant.TEXT_BOM, BuildConfig.VERSION_NAME, false);
        } else {

...
public class ay extends ax {
    ...
    public ay(Context context, ce ceVar, HandlerThread handlerThread) {
        ...
        if (this.A == null) {
            ...
            CharSequence e = x != null ? x.e(AudioDetector.RES_PATH) : null;
        ...
        this.A.setParameter("vad_bos", Integer.toString(this.r > 0 ? this.r : ProgressType.PRO_END));
    ...
    private byte[] a(byte[] bArr) {
        if (this.A != null) {
            ...
            if (z) {
                byte[] bArr2 = new byte[((bArr.length - i) + this.B.length)];
                if (this.B.length <= i) {
                    System.arraycopy(bArr, i - this.B.length, bArr2, 0, bArr2.length);
                } else {
                    System.arraycopy(this.B, i, bArr2, 0, this.B.length - i);
                    System.arraycopy(bArr, 0, bArr2, this.B.length - i, bArr.length);
                }
                bArr = bArr2;
            }

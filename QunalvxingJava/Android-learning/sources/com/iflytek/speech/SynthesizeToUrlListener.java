...
public interface SynthesizeToUrlListener extends IInterface {
    ...
    public abstract class Stub extends Binder implements SynthesizeToUrlListener {
        ...
        class Proxy implements SynthesizeToUrlListener {
            ...
            public void onSynthesizeCompleted(String str, int i) {

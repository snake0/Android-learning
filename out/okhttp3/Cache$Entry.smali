...
.method public constructor <init>(Lokio/Source;)V
    ...
    .line 545
    invoke-static {v5}, Lokhttp3/Cache;->readInt(Lokio/BufferedSource;)I
    ...
    invoke-virtual {v6, v8}, Lokhttp3/Headers$Builder;->addLenient(Ljava/lang/String;)Lokhttp3/Headers$Builder;
    ...
    iput-object v6, p0, Lokhttp3/Cache$Entry;->protocol:Lokhttp3/Protocol;

    .line 553
    iget v6, v4, Lokhttp3/internal/http/StatusLine;->code:I

    iput v6, p0, Lokhttp3/Cache$Entry;->code:I
    ...
    invoke-virtual {v6, v7}, Lokhttp3/Headers$Builder;->addLenient(Ljava/lang/String;)Lokhttp3/Headers$Builder;
    ...
    invoke-virtual {v6, v3}, Lokhttp3/Headers$Builder;->get(Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-virtual {v6, v4}, Lokhttp3/Headers$Builder;->get(Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-virtual {v6, v4}, Lokhttp3/Headers$Builder;->removeAll(Ljava/lang/String;)Lokhttp3/Headers$Builder;
    ...
    :cond_80
    iput-wide v1, p0, Lokhttp3/Cache$Entry;->receivedResponseMillis:J
    ...
    .line 579
    invoke-direct {p0, v5}, Lokhttp3/Cache$Entry;->readCertificateList(Lokio/BufferedSource;)Ljava/util/List;
    ...
    iput-object v0, p0, Lokhttp3/Cache$Entry;->handshake:Lokhttp3/Handshake;
    :try_end_e2
    .catchall {:try_start_be .. :try_end_e2} :catchall_b7
    ...
    iput-object v0, p0, Lokhttp3/Cache$Entry;->handshake:Lokhttp3/Handshake;
    :try_end_e9
    .catchall {:try_start_e7 .. :try_end_e9} :catchall_b7
...
.method public response(Lokhttp3/internal/cache/DiskLruCache$Snapshot;)Lokhttp3/Response;
    ...
    iget-wide v1, p0, Lokhttp3/Cache$Entry;->sentRequestMillis:J
    ...
    iget-wide v1, p0, Lokhttp3/Cache$Entry;->receivedResponseMillis:J
...
.method public writeTo(Lokhttp3/internal/cache/DiskLruCache$Editor;)V
    ...
    invoke-interface {v2, v3, v4}, Lokio/BufferedSink;->writeDecimalLong(J)Lokio/BufferedSink;

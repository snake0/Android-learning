...
public class bz {
    public static String a(NetworkInfo networkInfo) {
        ...
        try {
            ...
            return TextUtils.isEmpty(toLowerCase) ? "none" : (toLowerCase.startsWith("3gwap") || toLowerCase.startsWith("uniwap")) ? "uniwap" : toLowerCase.startsWith("cmwap") ? "cmwap" : toLowerCase.startsWith(NetRequestManager.CTWAP_APN_NAME_2) ? NetRequestManager.CTWAP_APN_NAME_2 : toLowerCase.startsWith("ctnet") ? "ctnet" : toLowerCase;
        } catch (Exception e) {
            cb.a(e.toString());
            return "none";
        }

...
public class cr extends cq {
        ...
        if (!MSC.isLoaded()) {
            ...
            try {
                ...
                if (TextUtils.isEmpty(parameter)) {
                    ...
                    CharSequence str32 = parameter;
                }
                byte[] bytes = str.getBytes(str32);
                MSCSessionInfo mSCSessionInfo = new MSCSessionInfo();
                int QMSPGetParam = MSC.QMSPGetParam(bytes, mSCSessionInfo);
                if (QMSPGetParam == 0) {
                    str4 = new String(mSCSessionInfo.buffer, str32);
                } else {
    ...
    /* JADX WARNING: Missing block: B:17:0x003b, code skipped:
            if ("local".equals(r3.w.A()) == false) goto L_0x007d;
     */
    ...
    public void a(com.iflytek.cloud.SpeechError r4) {
        /*
        r3 = this;
        r1 = r3.u;	 Catch:{ Throwable -> 0x0070 }
        monitor-enter(r1);	 Catch:{ Throwable -> 0x0070 }
        r0 = r3.x;	 Catch:{ all -> 0x007a }
    ...
    L_0x0009:
        r0 = 1;
        r3.x = r0;	 Catch:{ all -> 0x007a }
        monitor-exit(r1);	 Catch:{ all -> 0x007a }
        r0 = d();	 Catch:{ Throwable -> 0x0070 }
        if (r0 == 0) goto L_0x0008;
    L_0x0013:
        r0 = r3.w;	 Catch:{ Throwable -> 0x0070 }
        if (r0 == 0) goto L_0x0008;
    L_0x0017:
        r0 = r3.w;	 Catch:{ Throwable -> 0x0070 }
        r0 = r0.g();	 Catch:{ Throwable -> 0x0070 }
        r1 = android.text.TextUtils.isEmpty(r0);	 Catch:{ Throwable -> 0x0070 }
        if (r1 != 0) goto L_0x0008;
    L_0x0023:
        r1 = c;	 Catch:{ Throwable -> 0x0070 }
        r3.a(r1, r0);	 Catch:{ Throwable -> 0x0070 }
        r0 = d;	 Catch:{ Throwable -> 0x0070 }
        r1 = r3.y;	 Catch:{ Throwable -> 0x0070 }
        r3.a(r0, r1);	 Catch:{ Throwable -> 0x0070 }
        r0 = "local";
        r1 = r3.w;	 Catch:{ Throwable -> 0x0070 }
        r1 = r1.A();	 Catch:{ Throwable -> 0x0070 }
        r0 = r0.equals(r1);	 Catch:{ Throwable -> 0x0070 }
        if (r0 == 0) goto L_0x007d;
    L_0x003d:
        r0 = "csid:";
    L_0x003f:
        r1 = b;	 Catch:{ Throwable -> 0x0070 }
        r2 = new java.lang.StringBuilder;	 Catch:{ Throwable -> 0x0070 }
        r2.<init>();	 Catch:{ Throwable -> 0x0070 }
        r0 = r2.append(r0);	 Catch:{ Throwable -> 0x0070 }
        r2 = r3.w;	 Catch:{ Throwable -> 0x0070 }
        r2 = r2.B();	 Catch:{ Throwable -> 0x0070 }
        r0 = r0.append(r2);	 Catch:{ Throwable -> 0x0070 }
    ...
    L_0x005d:
        r0 = 0;
    L_0x005e:
        r1 = f;	 Catch:{ Throwable -> 0x0070 }
        r3.a(r1, r0);	 Catch:{ Throwable -> 0x0070 }
        r0 = e;	 Catch:{ Throwable -> 0x0070 }
        r1 = java.lang.System.currentTimeMillis();	 Catch:{ Throwable -> 0x0070 }
        r3.a(r0, r1);	 Catch:{ Throwable -> 0x0070 }
        r3.f();	 Catch:{ Throwable -> 0x0070 }
        goto L_0x0008;
    L_0x0070:
        r0 = move-exception;
        r1 = "DC exception:";
    ...
    L_0x007a:
        r0 = move-exception;
        monitor-exit(r1);	 Catch:{ all -> 0x007a }
        throw r0;	 Catch:{ Throwable -> 0x0070 }
    L_0x007d:
        r0 = "sid:";
        goto L_0x003f;
    L_0x0080:
        r0 = r4.getErrorCode();	 Catch:{ Throwable -> 0x0070 }
        goto L_0x005e;
        */

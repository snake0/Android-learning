...
public class ck extends bi {
    ...
    final class a implements VerifierListener {
        ...
        public void a() {
            ...
            if (!TextUtils.isEmpty(e) && bv.a(((ba) ck.this.e).j(), e)) {
                bv.a(ck.this.e.x().b(SpeechConstant.AUDIO_FORMAT, null), e, ck.this.e.x().a("sample_rate", ck.this.e.s));
            }
            bw.b(ck.this.a, Boolean.valueOf(ck.this.g), null);
        }
    ...
    public int a(VerifierListener verifierListener) {
        ...
        synchronized (this.d) {
            try {
                ...
                ((ba) this.e).a(new a(verifierListener));
                i = 0;
            } catch (SpeechError e) {

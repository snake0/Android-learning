...
public class ap {
    ...
    /* JADX WARNING: Missing block: B:10:0x0017, code skipped:
            com.iflytek.cloud.thirdparty.as.a("CAE engine setRealBeam fail. error=" + r0);
            r5.g.obtainMessage(3, new com.iflytek.cloud.thirdparty.aq(r0, "")).sendToTarget();
     */
    ...
    L_0x0007:
        ...
        com.iflytek.cloud.thirdparty.as.b(r0);	 Catch:{ all -> 0x003b }
        monitor-exit(r1);	 Catch:{ all -> 0x003b }
    L_0x000d:
        return;
    L_0x000e:
        r0 = b;	 Catch:{ all -> 0x003b }
        r0 = com.iflytek.cae.jni.CAEJni.CAESetRealBeam(r0, r6);	 Catch:{ all -> 0x003b }
        monitor-exit(r1);	 Catch:{ all -> 0x003b }
    ...
    /* JADX WARNING: Missing block: B:14:0x0028, code skipped:
            com.iflytek.cloud.thirdparty.as.a("CAE engine destroy fail. error=" + r0);
            r5.g.obtainMessage(3, new com.iflytek.cloud.thirdparty.aq(r0, "")).sendToTarget();
     */
    ...
    L_0x000d:
        r0 = a;	 Catch:{ all -> 0x005f }
        r0.f();	 Catch:{ all -> 0x005f }
    L_0x0012:
        r0 = b;	 Catch:{ all -> 0x005f }
        r0 = com.iflytek.cae.jni.CAEJni.CAEDestroy(r0);	 Catch:{ all -> 0x005f }
        if (r0 != 0) goto L_0x004c;
    L_0x001a:
        r2 = 0;
        b = r2;	 Catch:{ all -> 0x005f }
        r2 = 0;
        a = r2;	 Catch:{ all -> 0x005f }
        r2 = "CAE engine destroy sucess.";
        com.iflytek.cloud.thirdparty.as.a(r2);	 Catch:{ all -> 0x005f }
    L_0x0025:
        monitor-exit(r1);	 Catch:{ all -> 0x005f }
    ...
    L_0x004c:
        ...
        r2 = r2.append(r0);	 Catch:{ all -> 0x005f }

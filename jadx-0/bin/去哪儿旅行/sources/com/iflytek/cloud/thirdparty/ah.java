...
public class ah {
    ...
    public void a(ce ceVar, byte[] bArr, int i, boolean z) {
        synchronized (this) {
            String d;
            String c;
            int i2;
            ...
            if (z) {
                ...
                this.a = new an();
                this.a.a(ceVar);
                b.a("dts", BuildConfig.VERSION_NAME);
    ...
    L_0x0009:
        return;
    L_0x000a:
        r2 = java.lang.System.currentTimeMillis();	 Catch:{ all -> 0x0063 }
        r0 = r8.c;	 Catch:{ UnsupportedEncodingException -> 0x005d }
        r4 = "";
        r5 = "utf-8";
        r4 = r4.getBytes(r5);	 Catch:{ UnsupportedEncodingException -> 0x005d }
        r0 = com.iflytek.msc.MSC.AIUISessionEnd(r0, r4);	 Catch:{ UnsupportedEncodingException -> 0x005d }
    L_0x001c:
        r4 = java.lang.System.currentTimeMillis();	 Catch:{ all -> 0x0063 }
        r1 = 0;
        r8.c = r1;	 Catch:{ all -> 0x0063 }
        r1 = "AIUISession";
        r6 = new java.lang.StringBuilder;	 Catch:{ all -> 0x0063 }
        r6.<init>();	 Catch:{ all -> 0x0063 }
        r7 = "session end, ret=";
        r6 = r6.append(r7);	 Catch:{ all -> 0x0063 }
        r6 = r6.append(r0);	 Catch:{ all -> 0x0063 }
        r7 = ", spent=";
        r6 = r6.append(r7);	 Catch:{ all -> 0x0063 }
        r2 = r4 - r2;
        r2 = r6.append(r2);	 Catch:{ all -> 0x0063 }
        r3 = "ms";
        r2 = r2.append(r3);	 Catch:{ all -> 0x0063 }
        r2 = r2.toString();	 Catch:{ all -> 0x0063 }
        com.iflytek.cloud.thirdparty.cb.a(r1, r2);	 Catch:{ all -> 0x0063 }
        monitor-exit(r8);	 Catch:{ all -> 0x0063 }
        r1 = r8.i;
        r1.b();

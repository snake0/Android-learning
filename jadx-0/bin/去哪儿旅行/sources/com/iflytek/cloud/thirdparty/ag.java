...
public class ag {
    ...
    private void a(String str, String str2, int i, String str3) {
        ...
        this.f.a(("sid=" + str2 + IOUtils.LINE_SEPARATOR_UNIX).getBytes("utf-8"), true);
        this.f.a(("error=" + i + IOUtils.LINE_SEPARATOR_UNIX).getBytes("utf-8"), true);
        this.f.a(("des=" + str3).getBytes("utf-8"), true);
        this.f.a("\n\n".getBytes("utf-8"), true);
        this.f.d();
    }

    private void a(String str, String str2, long j, long j2, long j3, JSONObject jSONObject, String str3, JSONObject jSONObject2) {
        this.f.e();
        this.f.a(str, ".txt", true);
        this.f.a(("sid=" + str2 + IOUtils.LINE_SEPARATOR_UNIX).getBytes("utf-8"), true);
        ...
        if ("nlp".equals(str3)) {
            ...
            this.f.a(("bos_nlp=" + j2 + IOUtils.LINE_SEPARATOR_UNIX).getBytes("utf-8"), true);
            this.f.a(("eos_nlp=" + j3 + IOUtils.LINE_SEPARATOR_UNIX).getBytes("utf-8"), true);
        } else if ("iat".equals(str3)) {
            this.f.a(("bos_iat=" + j2 + IOUtils.LINE_SEPARATOR_UNIX).getBytes("utf-8"), true);
            this.f.a(("eos_iat=" + j3 + IOUtils.LINE_SEPARATOR_UNIX).getBytes("utf-8"), true);
        } else if ("asr".equals(str3)) {
            this.f.a(("bos_asr=" + j2 + IOUtils.LINE_SEPARATOR_UNIX).getBytes("utf-8"), true);
            this.f.a(("eos_asr=" + j3 + IOUtils.LINE_SEPARATOR_UNIX).getBytes("utf-8"), true);
    ...
    public void a(String str, String str2, Map<String, byte[]> map, String str3, String str4, long j) {
    ...
    public void errorCb(char[] cArr, int i, byte[] bArr) {
        try {

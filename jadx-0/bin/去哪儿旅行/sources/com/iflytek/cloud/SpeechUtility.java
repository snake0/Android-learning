...
public class SpeechUtility extends bh {
    ...
    public String getComponentUrl() {
        ...
        UtilityConfig.appendHttpParam(stringBuffer, ClientCookie.VERSION_ATTR, "2.0");
    ...
    public String getPlusLocalInfo(String str) {
        ...
        if (!checkServiceInstalled()) {
            ...
            jSONObject.put(TAG_RESOURCE_RESULT, new JSONObject(string2));
            return jSONObject.toString();
        } else {

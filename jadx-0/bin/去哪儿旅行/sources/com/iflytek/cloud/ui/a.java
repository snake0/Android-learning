...
public final class a extends cv implements OnClickListener {
    ...
    private void a(SpeechError speechError) {
        try {
            LinearLayout linearLayout = (LinearLayout) this.d.findViewWithTag(UIData.ERROR);
    ...
    public void a(TextView textView, SpeechError speechError) {
        ...
        boolean z = parameter != null && (parameter.equalsIgnoreCase("true") || parameter.equalsIgnoreCase(BuildConfig.VERSION_NAME));

...
public interface ITextUnderstander extends IInterface {
    ...
    public abstract class Stub extends Binder implements ITextUnderstander {
        ...
        class Proxy implements ITextUnderstander {
        ...
        public boolean onTransact(int i, Parcel parcel, Parcel parcel2, int i2) {
            switch (i) {
                case 1:
                    ...
                    understandText(parcel.readInt() != 0 ? (Intent) Intent.CREATOR.createFromParcel(parcel) : null, com.iflytek.speech.TextUnderstanderListener.Stub.asInterface(parcel.readStrongBinder()));

...
public class o extends e {
    ...
    private void g() {
        try {
            ...
            } else if (Math.abs(f.getFrameVersion() - 7.52f) < 1.0E-8f) {
                randomAccessFile.writeInt(0);
            }
            randomAccessFile.close();
        } catch (Exception e) {
    ...
    private boolean i() {
        return (this.c == null || new File(j.h() + File.separator + this.c).exists()) ? true : a("http://" + this.a + "/" + this.c, this.c);
    }
    ...
    public void c() {
        if (System.currentTimeMillis() - c.a().b() > DateTimeUtils.ONE_DAY) {

...
public class j {
    ...
    public static int ae = ProgressType.PRO_END;
    ...
    public static String a(a aVar, g gVar, Location location, String str, int i) {
        return a(aVar, gVar, location, str, i, false);
    }

    public static String a(a aVar, g gVar, Location location, String str, int i, boolean z) {
        String b;
    ...
    public static String a(String str) {
        return Jni.en1(n + VoiceWakeuperAidl.PARAMS_SEPARATE + str);
    }

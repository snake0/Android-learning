...
class a {
    ...
    static FavoritePoiInfo a(JSONObject jSONObject) {
        ...
        if (optJSONObject != null) {
            favoritePoiInfo.c = new LatLng(((double) optJSONObject.optInt(MapViewConstants.ATTR_Y)) / 1000000.0d, ((double) optJSONObject.optInt(MapViewConstants.ATTR_X)) / 1000000.0d);
        }

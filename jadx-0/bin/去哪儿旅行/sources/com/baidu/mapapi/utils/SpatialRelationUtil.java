...
public class SpatialRelationUtil {
    private static LatLng a(LatLng latLng, LatLng latLng2, LatLng latLng3) {
        ...
        return CoordUtil.mc2ll(new GeoPoint(((ll2mc2.getLatitudeE6() - ll2mc.getLatitudeE6()) * longitudeE6) + ll2mc.getLatitudeE6(), ll2mc.getLongitudeE6() + ((ll2mc2.getLongitudeE6() - ll2mc.getLongitudeE6()) * longitudeE6)));
    }
    ...
    public static LatLng getNearestPointFromLine(List<LatLng> list, LatLng latLng) {
        ...
        LatLng latLng2 = null;
        while (i < list.size() - 1) {
            LatLng a = a((LatLng) list.get(i), (LatLng) list.get(i + 1), latLng);

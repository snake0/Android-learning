...
public class BaiduMap {
    ...
    private Point a(String str) {
        ...
        for (String replaceAll : str.replaceAll("^\\{", "").replaceAll("\\}$", "").split(",")) {
            ...
            if (MapViewConstants.ATTR_X.equals(split[0])) {
                i2 = Integer.valueOf(split[1]).intValue();
            }
            if (MapViewConstants.ATTR_Y.equals(split[0])) {
            ...
            switch (this.d) {
                case TextureView:
                    if (this.b != null) {
                        ...
                        this.i.a(new Point((int) ((width * ((float) this.R.x)) + ((float) i)), (int) ((height * ((float) this.R.y)) + ((float) i2))));
            ...
            switch (this.d) {
                case TextureView:
                    if (this.b != null) {
                        f = (float) i;
                        f = (float) i2;
                        this.i.a(new Point((int) (((((float) ((this.b.getWidth() - i) - i3)) / ((float) this.b.getWidth())) * ((float) this.R.x)) + f), (int) (((((float) ((this.b.getHeight() - i2) - i4)) / ((float) this.b.getHeight())) * ((float) this.R.y)) + f)));
                        this.b.setPadding(i, i2, i3, i4);
                        this.b.invalidate();
                        return;
                    }
                ...
                case GLSurfaceView:
                    if (this.a != null) {
                        f = (float) i;
                        f = (float) i2;
                        this.i.a(new Point((int) (((((float) ((this.a.getWidth() - i) - i3)) / ((float) this.a.getWidth())) * ((float) this.R.x)) + f), (int) (((((float) ((this.a.getHeight() - i2) - i4)) / ((float) this.a.getHeight())) * ((float) this.R.y)) + f)));
                        this.a.setPadding(i, i2, i3, i4);
                        this.a.invalidate();
                        return;
                    }
    ...
    public void showInfoWindow(InfoWindow infoWindow) {
        if (infoWindow != null) {
            ...
            this.H = infoWindow;
            Overlay a = new MarkerOptions().perspective(false).icon(infoWindow.b != null ? BitmapDescriptorFactory.fromView(infoWindow.b) : infoWindow.a).position(infoWindow.c).zIndex(ProgressType.PRO_END).yOffset(infoWindow.e).a();
            a.listener = this.n;
            a.type = h.popup;
            Bundle bundle = new Bundle();
            a.a(bundle);

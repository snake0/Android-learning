...
public class FloatFieldDeserializer extends FieldDeserializer {
    ...
    public FloatFieldDeserializer(ParserConfig parserConfig, Class<?> cls, FieldInfo fieldInfo) {
        super(cls, fieldInfo);
    ...
    public void parseField(DefaultJSONParser defaultJSONParser, Object obj, Type type, Map<String, Object> map) {
        ...
        if (lexer.token() == 8) {
            ...
            obj2 = TypeUtils.castToFloat(defaultJSONParser.parse());
        }
        if (obj2 != null || getFieldClass() != Float.TYPE) {
            if (obj == null) {

            ...
            if ((next != 3 || xmlPullParser.getDepth() > depth) && next != 1) {
                if (next == 2) {
                    ...
                    if (name.equals("objectAnimator")) {
                        ...
                        createAnimatorFromXml(context, xmlPullParser, attributeSet, (AnimatorSet) animator, i3);
    ...
    private static ValueAnimator loadAnimator(Context context, AttributeSet attributeSet, ValueAnimator valueAnimator) {
        ...
        if (obj != null) {
            ...
            if (obj2 != null) {
                float dimension2;
                if (i2 == 5) {
                    dimension2 = obtainStyledAttributes.getDimension(5, 0.0f);
                } else {
                    dimension2 = obtainStyledAttributes.getFloat(5, 0.0f);
                }
                if (obj3 != null) {
                    if (i3 == 5) {
                        dimension = obtainStyledAttributes.getDimension(6, 0.0f);
                    } else {
                        dimension = obtainStyledAttributes.getFloat(6, 0.0f);
                    }
